...
// display day of the week,date,month,year on serial monitor
  Serial.print(week[now.dayOfTheWeek()]);
  Serial.print(" ");
  Serial.print(now.day(),DEC);// display day
  Serial.print('/');
  Serial.print(now.month(),DEC);// display month
  Serial.print('/');
  Serial.println(now.year(),DEC);// display year
  // display hour,minute,second on serial monitor
  Serial.print(now.hour(),DEC);// display Hour
  Serial.print(':');
  Serial.print(now.minute(),DEC);// display minute
  Serial.print(':');
